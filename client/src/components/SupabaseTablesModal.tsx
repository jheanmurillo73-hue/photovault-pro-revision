  ...
  > = {
    inspection_photos: {
      ...
      columns: [
        ...
        { name: 'execution_status', type: 'TEXT', constraints: "CHECK ('En proceso', 'Terminado')", description: 'Estado operativo del trabajo en campo' },
        ...
        { name: 'plan_layer', type: 'TEXT', constraints: "DEFAULT civil · CHECK ('civil', 'electrical')", description: 'Capa del plano: Obras Civiles u Obras Eléctricas' },
        { name: 'electrical_type', type: 'TEXT', constraints: 'NULL', description: 'Tipo de activo eléctrico: transformador, tablero, poste, reconectador o cableado' },
        { name: 'electrical_color', type: 'TEXT', constraints: 'NULL', description: 'Color hexadecimal asignado al símbolo o cableado eléctrico' },
