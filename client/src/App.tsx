...
const normalizeInspectionPhoto = (photo: InspectionPhoto): InspectionPhoto => ({
  ...
  planLayer: photo.electricalType || photo.planLayer === 'electrical' ? 'electrical' : 'civil',
...
export default function App() {
  ...
  const handleCreatePhotoFromPlan = (
    ...
    const elementName = isElectrical ? electricalOption.label : isCamera ? 'Cámara' : isPipeline ? 'Tramo de tubería' : 'Caja';
    const newPhoto = normalizeInspectionPhoto({
      ...
      elementType,
      planLayer: isElectrical ? 'electrical' : 'civil',
      ...
      metraje: isPipeline || electricalOption.linear ? initialMetraje ?? 0 : undefined,
